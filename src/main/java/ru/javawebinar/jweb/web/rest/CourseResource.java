...
import ru.javawebinar.jweb.repository.CourseRepository;
...
public class CourseResource {
    ...
    @Timed
    public ResponseEntity<Void> create(@Valid @RequestBody Course course) throws URISyntaxException {
    ...
    @RequestMapping(value = "/courses",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    public ResponseEntity<Void> update(@Valid @RequestBody Course course) throws URISyntaxException {
